...
%
%Written by :
%       Amin Sarafraz   Photogrammetry & Computer Vision Devision
%  Geomatics Department,Faculty of Engineering  University of Tehran,Iran  sarafraz@geomatics.ut.ac.ir
...
if nargin < 4 
    region = [1,1,imSize(2),imSize(1)]; end   
...
Accumulatortemp = Accumulator - max(Accumulator(:));
